...
### 7.6 Web 服务开机自启动 [DONE]
- [x] 创建开机自启动配置脚本 (scripts/setup_web_autostart.bat)
- [x] 创建删除自启动脚本 (scripts/remove_web_autostart.bat)
- [x] 支持用户登录时自动启动 Web 服务
- [x] 创建桌面快捷方式（手动启动）
